...
export default function Onetimecharges({Onback}) {
      ...
      <Box className="pricing-top-sub">
            ...
            <Box className="category-tabs">
              {categories.map((category) => (
                <button
                  key={category}
                  className={`pricing-buttons-lease ${activeTab === category ? "active" : ""}`}
              ...
              <Box className="col">
                ...
                <Box className="category-tabs">
                  {Chargeble.map((category) => (
                    <button
                      key={category}
                      className={`pricing-buttons-lease-yesno  ${act === category ? "active" : ""}`}
              ...
              <Box className="col">
                ...
                <Box className="category-tabs">
                  {Component.map((category) => (
                    <button
                      key={category}
                      className={`pricing-buttons-lease-yesno ${act1 === category ? "active" : ""}`}
